...
# project
rsync -azv --append-verify --stats --human-readable --info=progress2 -e "$COMMAND" /home/lore/Projects/federated-learning $NODE:/home/lmancuso/
...
#ssh -i $CERT_PATH -J $PROXY $NODE "cd federated_learning; conda_install.sh"
